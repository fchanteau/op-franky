...
{{/*
Name of the appsettings ConfigMap.
*/}}
{{- define "dotnet-api.appsettingsConfigMapName" -}}
{{- printf "%s-appsettings" (include "dotnet-api.fullname" .) }}
{{- end }}

{{/*
Checksum of the appsettings content, used to roll pods on config change.
*/}}
{{- define "dotnet-api.appsettingsChecksum" -}}
{{- .Values.appsettings | default "" | sha256sum }}
{{- end }}
